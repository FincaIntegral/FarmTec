...
import { RegistroComponent as GastosRegistroComponent } from './features/gastos/registro/registro.component';
import { UsuariosComponent } from './features/usuarios/usuarios.component';
import { MortalidadComponent } from './features/mortalidad/mortalidad.component';
...
export const routes: Routes = [
  { path: 'login', component: LoginComponent, canActivate: [guestGuard] },
  {
    ...
    children: [
      ...
      { path: 'gastos', component: GastosRegistroComponent, canActivate: [SOLO_DUENO_ADMIN], data: { title: 'Gastos' } },
      { path: 'mortalidad', component: MortalidadComponent, data: { title: 'Mortalidad' } },
      { path: 'historial', component: HistorialComponent, canActivate: [roleGuard('dueno_finca')], data: { title: 'Historial' } },
      { path: 'usuarios', component: UsuariosComponent, canActivate: [roleGuard('dueno_finca')], data: { title: 'Usuarios' } },
    ],
  },
  { path: '**', redirectTo: '' },
];
